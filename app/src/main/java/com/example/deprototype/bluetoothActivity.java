...
public class bluetoothActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnDiscoverable = findViewById(R.id.btnDiscover);
        ...
        //button that turns on or off bluetooth capabiliteis
    ...
    //method to enable or disable the device
    public void enableDisableBT(){
        if(mBluetoothAdapter == null){
            //should have a log statement here but whatever
        }
    ...
    //method for handling discovering other devices near the device
    public void btnDiscover(View view) {
        ...
        if(!mBluetoothAdapter.isDiscovering()){
            ...
            mBluetoothAdapter.startDiscovery();
            IntentFilter discoverDevicesIntent = new IntentFilter(BluetoothDevice.ACTION_FOUND);
            Log.d(TAG,"got here too");
            registerReceiver(mBroadcastReceiver3, discoverDevicesIntent);
            Log.d(TAG,"fucking kill me pls");
        }
    }
